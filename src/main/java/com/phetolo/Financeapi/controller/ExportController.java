...
@RestController
@RequestMapping("users/{userId}/transactions/export")
public class ExportController {
	...
	@GetMapping("/csv")
	public ResponseEntity<ApiResponse<byte[]>> getCsv(@PathVariable Long userId){
		String csv = export.exportTransactionsToCsv(userId);
